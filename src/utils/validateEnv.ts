...
const BIAGENT_ENV: EnvSpec[] = [
  ...
  { key: 'POSTGRES_HOST',        required: true,  description: 'PostgreSQL (MCP)' },
  { key: 'POSTGRES_USER',        required: true,  description: 'PostgreSQL (MCP)' },
  { key: 'POSTGRES_PASSWORD',    required: true,  description: 'PostgreSQL (MCP)' },
  { key: 'POSTGRES_DB',          required: true,  description: 'PostgreSQL (MCP)' },
